...
class App {
  ...
  static const String packageName = 'CFM\u{00AD}Learning';
  // Version of the WEB build, usually same as package, but it also has a
  // build numbers.
  static const String versionMajor = '0';
  ...
  static const String flutterVersion = '0.0.1 (html renderer)';
  static const String copyright = '© 2021 - 2023';
  static const String author = '璧馨研究院';
  static const String license = 'BSD 3-Clause License';
  static const String icon = 'assets/Icon-App-288x288@1x.png';
  static final Uri packageUri = Uri(
    scheme: 'https',
    host: 'github.com',
    path: '/xuanyunhui/cfm-learning',
  );
